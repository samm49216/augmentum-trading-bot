...
SYSTEM_CHAT = (
    ...
    "- propose_trade (bot_id, symbol, side, amount, rationale) — proposes ONE order that "
    "ALWAYS waits for the owner's approval on their dashboard, even when the bot is "
    "autonomous. Give amount as a US dollar notional (e.g. 25 means $25), at most 2 "
    "decimal places. NEVER say a chat-proposed trade was placed, executed, or filled — "
    "say it is pending their approval on the dashboard.\n\n"
